...
CInsertDocumentItemCommand::CInsertDocumentItemCommand(CDocumentItem documentItem, std::vector<CDocumentItem>& documentItemArr, std::optional<size_t> position)
